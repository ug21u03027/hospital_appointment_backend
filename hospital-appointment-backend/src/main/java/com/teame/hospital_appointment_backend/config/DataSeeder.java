...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        appt1.setStartTime(LocalTime.of(10, 0));
        appt1.setEndTime(LocalTime.of(10,30));
        ...
        appt2.setStartTime(LocalTime.of(11, 0));
        appt2.setEndTime(LocalTime.of(12,0));
        ...
        appt3.setStartTime(LocalTime.of(12, 0));
        appt3.setEndTime(LocalTime.of(12,20));
        ...
        appt4.setStartTime(LocalTime.of(13, 0));
        appt4.setEndTime(LocalTime.of(13,50));
        ...
        appt5.setStartTime(LocalTime.of(14, 0));
        appt5.setEndTime(LocalTime.of(15, 0));
        ...
        appt6.setStartTime(LocalTime.of(15, 0));
        appt6.setEndTime(LocalTime.of(15, 40));
